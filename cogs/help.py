...
REGISTRY: dict[str, list[tuple]] = {
    ...
    "antinuke": [
        ("antinuke",                        "View the anti-nuke dashboard",              "admin", False),
        ("antinuke enable",                 "Turn on burst-action protection",           "admin", False),
        ("antinuke disable",                "Turn off burst-action protection",          "admin", False),
        ("antinuke whitelist",              "View the exempt member list",               "admin", False),
        ("antinuke whitelist add @user",    "Exempt a member from anti-nuke checks",     "admin", False),
        ("antinuke whitelist remove @user", "Remove a member's exemption",               "admin", False),
        ("antinuke punishment strip/kick/ban","Set the response to a triggered burst",   "admin", False),
        ("antinuke logs #channel",          "Set the anti-nuke alert channel",           "admin", False),
    ],
    "roles": [
    ...
    "aliases": [
        ("alias",                           "View this server's command aliases",           "admin",    False),
        ("alias add <alias> <command>",     "Create a custom alias for a command",          "admin",    False),
        ("alias remove <alias>",            "Delete an alias",                              "admin",    False),
        ("alias info <alias>",              "See what an alias points to and who made it",  "everyone", False),
        ("alias clear",                     "Remove every alias on this server",            "admin",    False),
    ],
    "admin": [
...
CAT_META: dict[str, tuple[str, str, str]] = {
    ...
    "antinuke":   ("Anti-Nuke",    EMOJI_DOT_RED,   "Burst-action protection and whitelist"),
    ...
    "aliases":    ("Aliases",      EMOJI_SPARKLE,   "Custom command aliases per server"),
